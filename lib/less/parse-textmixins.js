        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
            while (1) {
                switch (_context7.prev = _context7.next) {
                    ...
                    case 33:
                        _context7.next = 35;
                        return (0, _file.writeFile)(outputDir + '/less/text-colors.less', styles.map(function (_ref12) {
                    ...
                    case 35:
                        _context7.next = 37;
                        return (0, _file.writeFile)(outputDir + '/less/text-mixins.less', mergeStyles(styles));
...
exports.default = function () {
    var _ref13 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(PWD) {
