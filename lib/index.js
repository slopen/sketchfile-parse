...
var run = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(argv, PWD) {
        var filename, outputDir, _filename, _outputDir, _filename2, inputDir;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.t0 = argv[2];
                        _context.next = _context.t0 === '--unpack' ? 3 : _context.t0 === '--extract' ? 8 : _context.t0 === '--pack' ? 17 : 22;
                        break;
                    ...
                    case 14:
                        _context.next = 16;
                        return (0, _parseTextstyles2.default)(PWD, _outputDir);
                    ...
                    case 17:
                        ...
                        inputDir = argv[4];
                        _context.next = 21;
                        return (0, _pack2.default)(PWD, _filename2, inputDir);
